...
public class HistoriFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_histori, container, false);

        swipeListView = (SwipeListView)v.findViewById(R.id.listview);

        test1adapter = new SpotAdapter(getActivity(), R.layout.fragment_histori, campaigns1test, swipeListView, "historie");
